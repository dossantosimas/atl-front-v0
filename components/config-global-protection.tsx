...
const STORAGE_KEY = "global_config_access_granted";
const STORAGE_TIMESTAMP_KEY = "global_config_access_timestamp";
const SESSION_DURATION = 60 * 60 * 1000; // 1 hora en milisegundos

interface ConfigGlobalProtectionProps {
  children: ReactNode;
}

export function ConfigGlobalProtection({ children }: ConfigGlobalProtectionProps) {
      ...
      <Dialog open={isOpen} onOpenChange={(open) => {
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              Esta sección requiere autenticación. Por favor, ingrese la clave de acceso para la configuración global.
            </DialogDescription>
          </DialogHeader>
