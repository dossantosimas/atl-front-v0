...
const STORAGE_KEY = "security_config_access_granted";
const STORAGE_TIMESTAMP_KEY = "security_config_access_timestamp";
const SESSION_DURATION = 60 * 60 * 1000; // 1 hora en milisegundos

interface SecurityConfigProtectionProps {
  children: ReactNode;
}

export function SecurityConfigProtection({ children }: SecurityConfigProtectionProps) {
  ...
  const handleCancel = () => {
    // Si cancela, redirigir a la página anterior
      ...
      <Dialog open={isOpen} onOpenChange={(open) => {
        ...
        >
          <DialogHeader>
            ...
            <DialogDescription>
              Esta sección requiere autenticación. Por favor, ingrese la clave de acceso para la configuración de seguridad.
            </DialogDescription>
          </DialogHeader>
